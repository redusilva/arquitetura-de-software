...
class ProfessorCreateTab extends StatefulWidget {
  final void Function(String name, String email, String registration) onCreate;

  const ProfessorCreateTab({Key? key, required this.onCreate})
    : super(key: key);

  @override
  _ProfessorCreateTabState createState() => _ProfessorCreateTabState();
}

class _ProfessorCreateTabState extends State<ProfessorCreateTab> {
