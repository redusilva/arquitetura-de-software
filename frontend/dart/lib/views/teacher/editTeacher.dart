...
import 'package:musa/services/professor/updateProfessor.dart';
import 'package:provider/provider.dart';

class TeacherEditTab extends StatefulWidget {
  final Map<String, dynamic>? student;

  const TeacherEditTab({
    Key? key,
    required this.student,
  }) : super(key: key);

  @override
  _TeacherEditTabState createState() => _TeacherEditTabState();
}

class _TeacherEditTabState extends State<TeacherEditTab> {
  ...
  @override
  void didUpdateWidget(covariant TeacherEditTab oldWidget) {
  ...
  void _handleSave() async{
    if (_formKey.currentState!.validate()) {
      await updateProfessor(id:  _idCtrl.text, name: _nameCtrl.text, email: _emailCtrl.text, registration: _regCtrl.text, token: Provider.of<UserProvider>(context,listen:false).user!.token);
      await getProfesspr(token: Provider.of<UserProvider>(context,listen:false).user!.token, context: context);
