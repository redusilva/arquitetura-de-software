...
import 'package:musa/services/professor/deleteProfessor.dart';
import 'package:musa/services/professor/getProfessor.dart';
import 'package:provider/provider.dart';

class TeacherDeleteTab extends StatefulWidget {
  final Map<String, dynamic>? student;

  const TeacherDeleteTab({
    Key? key,
...
class _StudentEditTabState extends State<TeacherDeleteTab> {
  ...
  @override
  void didUpdateWidget(covariant TeacherDeleteTab oldWidget) {
  ...
  void _handleSave() async{
    if (_formKey.currentState!.validate()) {
      await deleteProfessor(id:  _idCtrl.text, token: Provider.of<UserProvider>(context,listen:false).user!.token);
