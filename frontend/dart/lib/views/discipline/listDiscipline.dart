...
class DisciplineListTab extends StatelessWidget {
  const DisciplineListTab({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final students = Provider.of<SubjectProvider>(context).subjects;
