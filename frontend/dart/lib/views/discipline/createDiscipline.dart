...
import 'package:musa/services/disciplina/createDisciplina.dart';
import 'package:musa/services/disciplina/getDisciplina.dart';
import 'package:provider/provider.dart';

class DisciplineCreateTab extends StatefulWidget {
  final void Function(String name, String email, String registration) onCreate;

  const DisciplineCreateTab({Key? key, required this.onCreate}) : super(key: key);

  @override
  _DisciplineCreateTabState createState() => _DisciplineCreateTabState();
}

class _DisciplineCreateTabState extends State<DisciplineCreateTab> {
