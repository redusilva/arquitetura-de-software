...
class StudentDisciplineListTab extends StatelessWidget {
  const StudentDisciplineListTab({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final students = Provider.of<StudentDisciplineProvider>(context).teahers;
