...
class ProfessorDisciplineListTab extends StatelessWidget {
  const ProfessorDisciplineListTab({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final students = Provider.of<TeacherDisciplineProvider>(context).teahers;
